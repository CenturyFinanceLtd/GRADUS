...
const CourseManager = () => {
  ...
  useEffect(() => {
    ...
    const loadContent = async () => {
      ...
      try {
        const courseResult = await fetchCoursePage({ token });
        ...
        setHeroForm({
          tagIcon: courseResult?.hero?.tagIcon || "",
          tagText: courseResult?.hero?.tagText || "",
          title: courseResult?.hero?.title || "",
          description: courseResult?.hero?.description || "",
        });
