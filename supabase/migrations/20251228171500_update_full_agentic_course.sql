-- Upsert the Agentic AI course with full data, using standard ID format and extracting price
INSERT INTO public.course (
  ...
  '{"$oid": "691300440c7f03983dc0ed7a"}', -- Standardized ID format
  ...
  46000, -- Extracted from hero.priceINR
  $${
