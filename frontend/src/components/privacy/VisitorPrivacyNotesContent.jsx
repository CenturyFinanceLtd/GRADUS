const VisitorPrivacyNotesContent = () => {
  return (
          ...
          <div className='col-lg-10'>
            <article className='d-flex flex-column gap-32 text-neutral-700'>
              <header className='d-flex flex-column gap-12'>
                <h1 className='mb-8'>Visitor Privacy Notes</h1>
                <p className='mb-0'>*Visitors privacy notices are also displayed at the visitors’ entrance in Gradus offices.</p>
              </header>
...
export default VisitorPrivacyNotesContent;
