...
export const PROGRAMMES = [
  {
    ...
    courses: [
      ...
      {
        name: "Front End Development Mastery (HTML, CSS, JavaScript, React)",
        slug: "front-end-development-mastery-html-css-js-react",
      },
      {
      ...
      {
        name: "Mobile App Development Mastery (React Native)",
        slug: "mobile-app-development-mastery-react-native",
      },
      {
        name: "Cloud Computing & DevOps Mastery (AWS, Azure, Google Cloud)",
        slug: "cloud-computing-devops-mastery-aws-azure-gcp",
      },
      {
      ...
      {
        name: "Tableau & Power BI for Data Visualization",
        slug: "tableau-powerbi-for-data-visualization",
      },
      {
